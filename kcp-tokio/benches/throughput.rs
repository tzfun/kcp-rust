...
//!
//! Run with: `cargo bench -p kcp-tokio`
...
/// Benchmark: KCP send/recv round-trip throughput
...
/// Benchmark: Raw UDP send/recv round-trip throughput (baseline)
...
/// Benchmark: TCP send/recv round-trip throughput (baseline)
...
/// Benchmark: KCP latency (small message round-trip time)
